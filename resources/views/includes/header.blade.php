...
<body>
    <div class="top-right links">
        <nav id="main-nav" style="scroll-behavior: smooth;font-size:16px;">
            ...
            <label for="responsive-status-menu" class="responsive-toggle-menu"> <span class="icon-toggle"></span>
            </label>
            ...
            <div class="responsive-menu">
                <ul class="menu">
                    ...
                    <li class="item with-submenu"> <a href="javascript:void(0);">Eventos Anteriores</a>
                        <ul class="submenu">
                            <li class="subitem"><a href="http://ciistacna.com/2019/" style="width: 190px;">XX CIIS</a>
                            </li>
                            <li class="subitem"><a href="http://ciistacna.com/2018/" style="width: 190px;">XIX CIIS</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                    ...
                    <section class="seccion" style="width:400px;margin-top:-15px">
                        <div class="cuenta-regresiva contenedor">
                            <ul class="clearfix">
                                <br>
                                <li>
                                    <p id="dias" class="numero"></p> <span>días</span>
                                </li>
                                <li>
                                    <p id="horas" class="numero"></p> <span>horas</span>
                                </li>
                                <li>
                                    <p id="minutos" class="numero"></p> <span>minutos</span>
                                </li>
                                <li>
                                    <p id="segundos" class="numero"></p> <span>segundos</span>
                                </li>
                            </ul>
                        </div>
                    </section>
